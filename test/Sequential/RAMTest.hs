...
two512 :: Memory512
two512 = Memory512 empty64 two64 empty64 empty64 empty64 empty64 empty64 empty64

empty4K :: Memory4K
empty4K = Memory4K empty512 empty512 empty512 empty512 empty512 empty512 empty512 empty512

two4K :: Memory4K
two4K = Memory4K empty512 two512 empty512 empty512 empty512 empty512 empty512 empty512

empty16K :: Memory16K
empty16K = Memory16K empty4K empty4K empty4K empty4K empty4K empty4K empty4K empty4K

two16K :: Memory16K
two16K = Memory16K empty4K empty4K empty4K two4K empty4K empty4K empty4K empty4K
...
test_ram =
    testGroup
        ...
        [ testGroup "ram8"
            ...
            , testCase "8 Write Two" (assertEqual "" (bus16 0, Memory8 bus16Zero (bus16 2) bus16Zero bus16Zero bus16Zero bus16Zero bus16Zero bus16Zero) (state (ram8 (bus16 2) (_0, _0, _1) _1) empty))
            , testCase "8 Read Two" (assertEqual "" (bus16 2, two) (state (ram8 (bus16 484) (_0, _0, _1) _0) two))
            , testCase "8 Write Two (different address)" (assertEqual "" (bus16 0, Memory8 bus16Zero bus16Zero (bus16 2) bus16Zero bus16Zero bus16Zero bus16Zero bus16Zero) (state (ram8 (bus16 2) (_0, _1, _0) _1) empty))
            , testCase "8 Write 30843" (assertEqual "" (bus16 0, Memory8 bus16Zero bus16Zero bus16Zero bus16Zero bus16Zero bus16Zero bus16Zero (bus16 30843)) (state (ram8 (bus16 30843) (_1, _1, _1) _1) empty))
            ]
        , testGroup "ram64"
