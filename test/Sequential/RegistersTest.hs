...
test_registers =
    testGroup
        ...
        [ testGroup "registerBit"
            [ testCase "" (assertEqual "" (bit "0", bit "0") (state (registerBit (bit "0") (bit "0")) (bit "0")))
            , testCase "" (assertEqual "" (bit "0", bit "0") (state (registerBit (bit "0") (bit "1")) (bit "0")))
            , testCase "" (assertEqual "" (bit "0", bit "0") (state (registerBit (bit "1") (bit "0")) (bit "0")))
            , testCase "" (assertEqual "" (bit "0", bit "1") (state (registerBit (bit "1") (bit "1")) (bit "0")))
            , testCase "" (assertEqual "" (bit "1", bit "1") (state (registerBit (bit "0") (bit "0")) (bit "1")))
            , testCase "" (assertEqual "" (bit "1", bit "0") (state (registerBit (bit "0") (bit "1")) (bit "1")))
            , testCase "" (assertEqual "" (bit "1", bit "1") (state (registerBit (bit "1") (bit "0")) (bit "1")))
            , testCase "" (assertEqual "" (bit "1", bit "1") (state (registerBit (bit "1") (bit "1")) (bit "1")))
            ]
        , testGroup "register"
            [ testCase "" (assertEqual "" (bus16 0, bus16 0) (state (register (bus16 348) (bit "0")) (bus16 0)))
            , testCase "" (assertEqual "" (bus16 0, bus16 348) (state (register (bus16 348) (bit "1")) (bus16 0)))
            ]
